...
# Federation identity domain — used for did:web DID generation
if loomkin_domain = System.get_env("LOOMKIN_DOMAIN") do
  config :loomkin, Loomkin.Federation.Identity, domain: loomkin_domain
end
